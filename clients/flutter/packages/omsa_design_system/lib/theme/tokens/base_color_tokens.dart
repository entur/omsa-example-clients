...
abstract class BaseLightTokens {
  ...
  static const Color shapeSubduedAlt = SemanticColorTokens.shapeSubduedAlt;
  static const Color shapeTaxiContrast = TransportColorTokens.contrastTaxi;
  static const Color shapeTaxiDefault = TransportColorTokens.standardTaxi;
  static const Color shapeTrainContrast = TransportColorTokens.contrastTrain;
  static const Color shapeTrainDefault = TransportColorTokens.standardTrain;
  static const Color shapeTramContrast = TransportColorTokens.contrastTram;
  ...
  static const Color strokeDefault = SemanticColorTokens.strokeAccent;
  static const Color strokeDisabled = SemanticColorTokens.strokeNeutralAlt;
  static const Color strokeFocusContrast = SemanticColorTokens.strokeContrast;
  static const Color strokeFocusStandard = SemanticColorTokens.strokeAccent;
  static const Color strokeHighlight = SemanticColorTokens.strokeHighlight;
  static const Color strokeLight = SemanticColorTokens.strokeLight;
  static const Color strokeSubdued = SemanticColorTokens.strokeSubdued;
  static const Color strokeSubduedAlt = SemanticColorTokens.strokeNeutral;

  // Text
  static const Color textAccent = SemanticColorTokens.textAccent;
  static const Color textDisabled = SemanticColorTokens.textNeutral;
  static const Color textDisabledAlt = SemanticColorTokens.textNeutralAlt;
  static const Color textHighlight = SemanticColorTokens.strokeHighlight;
  static const Color textLight = SemanticColorTokens.textLight;
  static const Color textSubdued = SemanticColorTokens.textSubdued;
  static const Color textSubduedAlt = SemanticColorTokens.textSubduedAlt;
}
...
abstract class BaseDarkTokens {
  ...
  // Shape
  static const Color shapeAccent = SemanticColorTokens.shapeLightAlt;
  static const Color shapeBicycleContrast = TransportColorTokens.darkBicycle;
  static const Color shapeBicycleDefault = TransportColorTokens.darkBicycle;
  static const Color shapeBusContrast = TransportColorTokens.darkBus;
  static const Color shapeBusDefault = TransportColorTokens.darkBus;
  static const Color shapeCablewayContrast = TransportColorTokens.darkCableway;
  static const Color shapeCablewayDefault = TransportColorTokens.darkCableway;
  static const Color shapeDisabled = SemanticColorTokens.shapeNeutralAlt;
  ...
  static const Color shapeMobilityDefault = TransportColorTokens.darkMobility;
  static const Color shapePlaneContrast = TransportColorTokens.darkPlane;
  static const Color shapePlaneDefault = TransportColorTokens.darkPlane;
  static const Color shapeSubdued = SemanticColorTokens.shapeDarkAlt;
  static const Color shapeSubduedAlt = SemanticColorTokens.shapeDarkAlt;
  static const Color shapeTaxiContrast = TransportColorTokens.darkTaxi;
  static const Color shapeTaxiDefault = TransportColorTokens.darkTaxi;
  static const Color shapeTrainContrast = TransportColorTokens.darkTrain;
  static const Color shapeTrainDefault = TransportColorTokens.darkTrain;
  static const Color shapeTramContrast = TransportColorTokens.darkTram;
  ...
  // Stroke
  static const Color strokeContrast = SemanticColorTokens.strokeContrast;
  static const Color strokeDefault = SemanticColorTokens.strokeDark;
  static const Color strokeDisabled = SemanticColorTokens.strokeNeutral;
  static const Color strokeFocusContrast = SemanticColorTokens.strokeContrast;
  static const Color strokeFocusStandard = SemanticColorTokens.strokeContrast;
  static const Color strokeHighlight = SemanticColorTokens.strokeHighlightAlt;
  static const Color strokeLight = SemanticColorTokens.strokeDark;
  static const Color strokeSubdued = SemanticColorTokens.strokeDarkAlt;
  static const Color strokeSubduedAlt = SemanticColorTokens.strokeNeutralAlt;

  // Text
  static const Color textAccent = SemanticColorTokens.textLightAlt;
  static const Color textDisabled = SemanticColorTokens.textNeutralAlt;
  static const Color textDisabledAlt = SemanticColorTokens.textNeutralAlt;
  static const Color textHighlight = SemanticColorTokens.strokeHighlightAlt;
  static const Color textLight = SemanticColorTokens.textLightAlt;
  static const Color textSubdued = SemanticColorTokens.textDarkAlt;
  static const Color textSubduedAlt = SemanticColorTokens.textDarkAlt;
}
