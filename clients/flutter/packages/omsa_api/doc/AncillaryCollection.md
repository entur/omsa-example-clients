# omsa_api.model.AncillaryCollection
...
------------ | ------------- | ------------- | -------------
**type** | **String** |  | 
**ancillaries** | [**List<AncillaryCollectionAncillariesInner>**](AncillaryCollectionAncillariesInner.md) |  | [optional] [default to const []]
