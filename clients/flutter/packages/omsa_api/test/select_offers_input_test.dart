...
// tests for SelectOffersInput
void main() {
  // final instance = SelectOffersInput();

  group('test SelectOffersInput', () {
    // Component-based selection of offers and their ancillaries.
    // List<SelectOffersInputSelectionsInner> selections (default value: const [])
