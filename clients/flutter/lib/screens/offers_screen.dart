...
class OffersScreen extends StatelessWidget {
  ...
  void _handleSelect(BuildContext context, Offer offer) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => PurchaseFlowScreen(offer: offer),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _FeatureChip(
                  icon: summary.isRefundable
                      ? Icons.check_circle
                      : Icons.cancel,
                  label: summary.isRefundable ? 'Refundable' : 'Non-refundable',
                  isPositive: summary.isRefundable,
                ),
                const SizedBox(width: 8),
                _FeatureChip(
                  icon: summary.isExchangeable ? Icons.swap_horiz : Icons.block,
                  label: summary.isExchangeable
                      ? 'Exchangeable'
                      : 'Non-exchangeable',
                  isPositive: summary.isExchangeable,
                ),
              ],
            ),
